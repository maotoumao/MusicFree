...
interface ISearchMusicListProps {}
...
function filterMusic(query: string, musicList: IMusic.IMusicItem[]) {
  ...
  return musicList.filter(_ =>
    `${_.title} ${_.artist} ${_.album} ${_.platform}`.includes(query.trim()),
  );
}

export default function SearchMusicList(props: ISearchMusicListProps) {
