    ...
    const options = [
        {
            title: '允许与其他应用同时播放',
            right: () => (
                <ThemeSwitch value={basicSetting?.notInterrupt ?? false} />
            ),
            onPress() {
                Config.set(
                    'setting.basic.notInterrupt',
                    !basicSetting?.notInterrupt,
                );
            },
        },
        {
            ...
            onPress() {
                Config.set(
                    ...
                    !basicSetting?.autoStopWhenError,
                );
            },
        },
        {
        ...
        },
        {
            title: '记录错误日志',
            right: () => (
                <ThemeSwitch value={basicSetting?.debug?.errorLog ?? false} />
            ),
            onPress() {
                Config.set(
        ...
        },
        {
            title: '记录详细日志',
            right: () => (
                <ThemeSwitch value={basicSetting?.debug?.traceLog ?? false} />
            ),
            onPress() {
                Config.set(
